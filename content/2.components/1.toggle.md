...
::PreviewCode
---
preview: ExampleToggle
---
#code

```vue 
<template>
  <div class="itemce' flex justify-center">
    <UIToggle label="Airplane Mode" v-model="mode" />
  </div>
</template>
