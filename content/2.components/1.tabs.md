...
<script setup lang="ts">
  ...
  const variants = cva("inline-flex items-center justify-center gap-2 text-sm focus:outline-none", {
    variants: {
      type: {
        underline:
          "z-[1] whitespace-nowrap border-b-2 border-b-transparent px-4 py-3 text-foreground/70 transition hover:border-primary focus:outline-none data-[headlessui-state=selected]:border-primary data-[headlessui-state=selected]:text-primary",
