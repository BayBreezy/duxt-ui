---
title: "Slider"
description: Allow your users to select a number from a range slider
---

::PreviewCode
---
preview: ExampleSlider
---
#code
...
- Install the [Vue 3 Slider package](https://github.com/vueform/slider/tree/main#installation)
...
You can visit the documentation to learn more about the props that can be passed to the component.

::PreviewCode
---
preview: ExampleSliderProps
---
#code
